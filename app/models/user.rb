class User < ApplicationRecord
  ...
  has_many :followers, through: :passive_relationships, source: :follower # :followersの単数形は:followerになるので、source: :followerの記述は不要。:followingと対比させるためにあえて明示的に記述している。
